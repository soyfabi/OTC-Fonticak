...
function init()
  ...
  botButton = modules.game_mainpanel.addSpecialToggleButton('botButton', tr('Bot Hub'), '/images/options/bot', toggle, false, 3)
...
function terminate()
  ...
  ItemSelector.terminate()
  BotTextEditor.terminate()
  BotButtons.terminate()
  terminateCallbacks()
  editWindow:destroy()
