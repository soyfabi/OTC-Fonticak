TargetBot.Creature.edit = function(config, callback) -- callback = function(newConfig)
  ...
  local addTextEdit = function(id, title, defaultValue)
    ...
    -- Inside ScrollablePanel the TextEdit never receives keyboard (Target name works
    -- because it is outside). Open a native InputBox popup instead.
    local openEditor = function()
      modules.game_bot.showTextEdit(widget.textEdit, {
        title = title,
