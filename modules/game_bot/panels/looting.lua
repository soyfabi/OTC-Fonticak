...
Panel
  ...
  ui.add.onClick = function()
    modules.game_bot.multilineEditor("Looting editor", "name:Config name", function(newText)
  ...
  ui.edit.onClick = function()
    ...
    modules.game_bot.multilineEditor("Looting editor", context.storage.looting.configs[context.storage.looting.activeConfig], function(newText)
